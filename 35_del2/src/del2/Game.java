...
static Fields[] field = new Fields[13];{
	...
	public static void main(String[] args) {
		...
		do {
			...
			do {
			System.out.println(p1.getName() + " kast med terningerne");
			...
			/**
			 * NULL POINTER ERROR!!!! - RIP SKINS BOIS....
			 * Fix nullpointer error == win..
			 */
			
			System.out.println(r1);
			System.out.println(field[r1].getfname());
			
			// var inde i addToCurrentBalance: field[r1].getval()
			a1.addToCurrentBalance(100);
			...
			do {
				System.out.println(p2.getName() + " kast med terningerne");
